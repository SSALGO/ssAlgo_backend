...
class Exchange:
    def __init__(self, api,db,cred,reapi):
        ...
        self.symbols_tok = {'NSE|26037':'FINNIFTY','NSE|26009': 'BANKNIFTY','NSE|26074':'MIDCPNIFTY',
                            ...
                            ,self.Nfo[(self.Nfo['Symbol'] == 'NIFTY') & (self.Nfo['Expiry_'].dt.date >= datetime.date.today()) & (self.Nfo['OptionType'] == 'XX')].iloc[2]['FToken']:'NIFTY-III'
                            ...
                            ,self.Nfo[(self.Nfo['Symbol'] == 'BANKNIFTY') & (self.Nfo['Expiry_'].dt.date >= datetime.date.today()) & (self.Nfo['OptionType'] == 'XX')].iloc[2]['FToken']:'BANKNIFTY-III'
                            ...
                            ,self.Nfo[(self.Nfo['Symbol'] == 'FINNIFTY') & (self.Nfo['Expiry_'].dt.date >= datetime.date.today()) & (self.Nfo['OptionType'] == 'XX')].iloc[2]['FToken']:'FINNIFTY-III'
                            ...
                            ,self.Nfo[(self.Nfo['Symbol'] == 'MIDCPNIFTY') & (self.Nfo['Expiry_'].dt.date >= datetime.date.today()) & (self.Nfo['OptionType'] == 'XX')].iloc[2]['FToken']:'MIDCPNIFTY-III'
        ...
        ,
        'NIFTY-III':self.Nfo[(self.Nfo['Symbol'] == 'NIFTY') & (self.Nfo['Expiry_'].dt.date >= datetime.date.today()) & (self.Nfo['OptionType'] == 'XX')].iloc[2]['FToken'],
        ...
        'BANKNIFTY-III':self.Nfo[(self.Nfo['Symbol'] == 'BANKNIFTY') & (self.Nfo['Expiry_'].dt.date >= datetime.date.today()) & (self.Nfo['OptionType'] == 'XX')].iloc[2]['FToken'],
        ...
        'FINNIFTY-III':self.Nfo[(self.Nfo['Symbol'] == 'FINNIFTY') & (self.Nfo['Expiry_'].dt.date >= datetime.date.today()) & (self.Nfo['OptionType'] == 'XX')].iloc[2]['FToken'],
        ...
        'MIDCPNIFTY-III':self.Nfo[(self.Nfo['Symbol'] == 'MIDCPNIFTY') & (self.Nfo['Expiry_'].dt.date >= datetime.date.today()) & (self.Nfo['OptionType'] == 'XX')].iloc[2]['FToken'],
        ...
        self.stok_symbols = {
             "CRUDEOIL": self.Mcx[(self.Mcx['Symbol'] == 'CRUDEOIL') & (
            self.Mcx['Expiry_'].dt.date >= datetime.date.today()) & (self.Mcx['OptionType'] == 'XX')].iloc[0]['SToken'],
        ...
        ,
        'NIFTY-III':self.Nfo[(self.Nfo['Symbol'] == 'NIFTY') & (self.Nfo['Expiry_'].dt.date >= datetime.date.today()) & (self.Nfo['OptionType'] == 'XX')].iloc[2]['SToken'],
        ...
        'BANKNIFTY-III':self.Nfo[(self.Nfo['Symbol'] == 'BANKNIFTY') & (self.Nfo['Expiry_'].dt.date >= datetime.date.today()) & (self.Nfo['OptionType'] == 'XX')].iloc[2]['SToken'],
        ...
        'FINNIFTY-III':self.Nfo[(self.Nfo['Symbol'] == 'FINNIFTY') & (self.Nfo['Expiry_'].dt.date >= datetime.date.today()) & (self.Nfo['OptionType'] == 'XX')].iloc[2]['SToken'],
        ...
        'MIDCPNIFTY-III':self.Nfo[(self.Nfo['Symbol'] == 'MIDCPNIFTY') & (self.Nfo['Expiry_'].dt.date >= datetime.date.today()) & (self.Nfo['OptionType'] == 'XX')].iloc[2]['SToken'],
        ...
        self.Mcx[(self.Mcx['Symbol'] == 'CRUDEOIL') & (self.Mcx['Expiry_'].dt.date >= datetime.date.today()) & (self.Mcx['OptionType'] == 'XX')].iloc[0]['SToken']: 'CRUDEOIL'
                            ...
                            ,self.Nfo[(self.Nfo['Symbol'] == 'NIFTY') & (self.Nfo['Expiry_'].dt.date >= datetime.date.today()) & (self.Nfo['OptionType'] == 'XX')].iloc[2]['SToken']:'NIFTY-III'
                            ...
                            ,self.Nfo[(self.Nfo['Symbol'] == 'BANKNIFTY') & (self.Nfo['Expiry_'].dt.date >= datetime.date.today()) & (self.Nfo['OptionType'] == 'XX')].iloc[2]['SToken']:'BANKNIFTY-III'
                            ...
                            ,self.Nfo[(self.Nfo['Symbol'] == 'FINNIFTY') & (self.Nfo['Expiry_'].dt.date >= datetime.date.today()) & (self.Nfo['OptionType'] == 'XX')].iloc[2]['SToken']:'FINNIFTY-III'
                            ...
                            ,self.Nfo[(self.Nfo['Symbol'] == 'MIDCPNIFTY') & (self.Nfo['Expiry_'].dt.date >= datetime.date.today()) & (self.Nfo['OptionType'] == 'XX')].iloc[2]['SToken']:'MIDCPNIFTY-III'
        ...
        self.hist('BANKNIFTY-III', tf="1",initial=True)
        self.hist('NIFTY-III', tf="1",initial=True)
        self.hist('FINNIFTY-III', tf="1",initial=True)
        self.hist('MIDCPNIFTY-III', tf="1",initial=True)
    ...
    def _dataloader(self):
        ...
        symbols = ['BANKNIFTY', 'NIFTY', 'FINNIFTY','MIDCPNIFTY','BANKNIFTY-I', 'NIFTY-I', 'FINNIFTY-I','MIDCPNIFTY-I','BANKNIFTY-II', 'NIFTY-II', 'FINNIFTY-II','MIDCPNIFTY-II','BANKNIFTY-III', 'NIFTY-III', 'FINNIFTY-III','MIDCPNIFTY-III']
        ...
        while True:
            ...
            try:
                if (datetime.datetime.today().weekday() < self.marketdays) and datetime.time(8,59) < datetime.datetime.now().time() and datetime.time(15,28) > datetime.datetime.now().time():
    ...
    def _datascript(self):
        ...
        while True:
            try:
                ...
                #mains = list(self.strategy_collection.find({'$or': [ {'position': 'in'}]}))
                
                #mains = list(self.strategy_collection.find({'status': {'$in': ['opened', 'paused']}}))
                #print(mains)
                #print(self.prices)
                with concurrent.futures.ThreadPoolExecutor() as executor:
        ...
        if self.testmode or ((trade['user'] in self.userloggedin) and (datetime.date.today().weekday() < self.marketdays)):
            try:
                ...
                if  len(self.dataframes[symbol]) >0:#.empty:
                    df=self.dataframes[symbol].iloc[-self.candleswitch[trade['timeframe']]:]
                    ...
                    dfList = []
                    for k, res in gp:
                        resampledf = res.resample('{}min'.format(self.timeswitch[trade['timeframe']]), origin='start').agg({'open': 'first', 
                                                       'high': 'max', 
                                                     'low': 'min', 
                    ...
                    #print(dfList)
                    df=df.reset_index()
                    lasttimedate=df1['date'].iloc[-1]+pd.to_timedelta(int(self.timeswitch[trade['timeframe']])-1,'minutes')
                    #print(lasttimedate)
                    ...
                    #print(df1)
                    Signal=0
                    ema1=TA.EMA(df1,trade['r1'])
                    ema2=TA.EMA(df1,trade['k1'])
                    df1['short']=ema1
                    df1['long']=ema2
                    ...
                    if trade['Newsignal'] :
                        ...
                        if (trends[-trade['candle1']]==0):
                            ...
                            exSignal=-1
                    elif not trade['Newsignal'] and trade['timetowait'] <= int(datetime.datetime.now().timestamp()) :
